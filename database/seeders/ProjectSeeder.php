    ...
    public function run(): void
    {
        ...
        $projectsData = [
            ...
            [
                ...
                'materials' => 'Solid Oak, Wood Glue, Danish Oil', 'estimated_hours' => 15, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Woodworking', 'Home Decor'], 'tools' => ['Saw', 'Hammer', 'Chisel Set', 'Sandpaper'],
            ...
            [
                ...
                'materials' => 'Basswood Block, Beeswax Polish', 'estimated_hours' => 8, 'is_public' => true, 'is_blocked' => true,
                'categories' => ['Woodworking', 'Sculpting'], 'tools' => ['Chisel Set', 'Craft Knife'],
            ...
            [
                ...
                'materials' => 'Reclaimed Pallet Wood, Screws, Wood Stain', 'estimated_hours' => 6, 'is_public' => false, 'is_blocked' => false,
                'categories' => ['Woodworking', 'Home Decor'], 'tools' => ['Saw', 'Drill', 'Screwdriver Set', 'Sandpaper'],
            ...
            [
                ...
                'materials' => 'Multi-colored wool yarn, 5mm crochet hook', 'estimated_hours' => 25, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Crochet', 'Quilting', 'Home Decor'], 'tools' => ['Yarn', 'Needles'],
            ...
            [
                ...
                'materials' => 'Origami paper, String, Wooden hoop', 'estimated_hours' => 5, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Origami', 'Paper Craft', 'For Kids'], 'tools' => ['Craft Knife'],
            ...
            [
                ...
                'materials' => 'Stoneware clay, Blue speckle glaze', 'estimated_hours' => 6, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Pottery', 'Home Decor', 'Gardening'], 'tools' => ['Pottery Wheel', 'Clay'],
            ...
            [
                ...
                'materials' => 'Scrap steel, Welding rods', 'estimated_hours' => 4, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Metalwork', 'Sculpting'], 'tools' => ['Soldering Iron', 'Pliers', 'Wrench'],
            ...
            [
                ...
                'materials' => 'Large paper, Non-toxic finger paints, Apron', 'estimated_hours' => 1, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['For Kids', 'Painting'], 'tools' => [],
            ...
            [
                ...
                'materials' => 'Large canvas, Acrylic paints, Palette knives', 'estimated_hours' => 6, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Painting'], 'tools' => ['Paint Brushes', 'Easel'],
            ...
            [
                ...
                'materials' => 'Weather-resistant lumber, Screws, Wood sealant', 'estimated_hours' => 4, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Gardening', 'Woodworking', 'Home Decor'], 'tools' => ['Saw', 'Drill', 'Measuring Tape'],
            ...
            [
                ...
                'materials' => 'Soy wax flakes, Wicks, Essential oils, Jars', 'estimated_hours' => 2, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Candle Making', 'Home Decor'], 'tools' => [],
                'cover_image' => 'project_pottery_2_cover.jpg', 'gallery_images' => ['project_pottery_3_cover.jpg'],
            ],
            [
                'user' => 'marta', 
                ...
                'materials' => 'Reclaimed wood plank, Outdoor paint, Stencils', 'estimated_hours' => 3, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Gardening', 'Woodworking', 'Painting'], 'tools' => ['Sandpaper', 'Paint Brushes'],
                'cover_image' => 'project_gardening_1_cover.jpg', 'gallery_images' => ['project_gardening_1_gallery_1.jpg'],
            ],
            [
                'user' => 'marta', 
                ...
                'materials' => 'Fine wool yarn, Small crochet hook', 'estimated_hours' => 12, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Crochet', 'Fashion Design'], 'tools' => ['Yarn', 'Needles'],
                'cover_image' => 'project_crochet_2_cover.jpg', 'gallery_images' => [],
            ],
            [
                'user' => 'marta', 
                ...
                'materials' => 'Scrapbook paper, Photo adhesives, Embellishments, Stickers', 'estimated_hours' => 5, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Scrapbooking', 'Photography', 'Paper Craft'], 'tools' => ['Craft Knife'],
                'cover_image' => 'project_scrapbooking_1_cover.jpg', 'gallery_images' => [],
            ],
             // Vilnis (Blocked User) - 1 project
            [
                'user' => 'vilnis', 
                'title' => 'Beginner\'s Guide to Painting',
                'description' => 'A simple acrylic painting of a landscape, designed for absolute beginners. This guide covers basic color mixing, brush strokes, and composition to get you started on your painting journey.',
                'materials' => 'Canvas, Acrylic paint set, Brushes', 'estimated_hours' => 3, 'is_public' => true, 'is_blocked' => false,
                'categories' => ['Painting', 'Digital Art'], 'tools' => ['Paint Brushes', 'Easel'],
                'cover_image' => 'project_painting_1_cover.jpg', 'gallery_images' => [],
            ],
        ];

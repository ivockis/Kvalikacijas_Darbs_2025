            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" x-data="{
                    ...
                    <div class="mb-4 flex flex-wrap items-end gap-4">
                        <div class="flex-grow">
                            ...
                            <input type="text" x-model.debounce.500ms="search" placeholder="Search by username or email..." class="w-full rounded-md shadow-sm border-gray-300">
                        </div>
                        <div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 text-center relative">
                                            ...
                                            <div x-show="confirmingUser && confirmingUser.id === user.id && confirmingAction === 'admin'" 
                                                ...
                                                <p class="text-sm text-gray-700" x-text="`Are you sure to change admin status for ${user.username}?`"></p>
                                        ...
                                        <td class="px-6 py-4 text-center relative">
                                            ...
                                            <div x-show="confirmingUser && confirmingUser.id === user.id && confirmingAction === 'block'" 
                                                 class="absolute z-10 right-0 mt-2 w-64 bg-white border border-gray-300 rounded-lg shadow-lg p-4"
                                                 @click.outside="cancelConfirmation()">
                                                <p class="text-sm text-gray-700" x-text="`Are you sure to block/unblock user ${user.username}?`"></p>
                                                <div class="mt-4 flex justify-end space-x-2">
                                                    <button @click="cancelConfirmation()" class="px-3 py-1 text-sm text-gray-600 bg-gray-200 hover:bg-gray-300 rounded-md">Cancel</button>

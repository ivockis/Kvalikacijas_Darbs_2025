                ...
                <div class="p-6 text-gray-200" x-data="{ confirmingDelete: null }">
                    <div class="mb-6">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 no-print">
                                                            @can('update', $project)
                        ...
                        <div class="flex items-center space-x-2 mb-4 no-print">
                            ...
                            <div class="w-px h-6 bg-gray-600 mx-2 no-print"></div> <!-- Divider -->
                            <!-- Like Button -->
                            @auth
                                <div x-data="{ 
                                ...
                                }" class="flex items-center space-x-2 no-print">
                                    ...
                                    <div class="flex space-x-4" 
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center space-x-2">
                                                    @canany(['update', 'delete'], $comment)
                                                        ...
                                                        {{-- Delete Button --}}
                                                        @can('delete', $comment)
                                                            <button x-show="!isEditing" @click="$dispatch('open-modal', 'confirm-comment-deletion-{{ $comment->id }}')" class="text-red-600 hover:text-red-900 text-sm">{{ __('Delete') }}</button>
                                                        @endcan
                                                    @endcanany
                                            ...
                                            <x-modal name="confirm-comment-deletion-{{ $comment->id }}" focusable>
                                                <form method="post" action="{{ route('comments.destroy', $comment) }}" class="p-6 bg-gray-800">
                                                    @csrf
                                                    @method('delete')
                                                    ...
                                                    <p class="mt-1 text-sm text-gray-400">
                                                        {{ __('Once this comment is deleted, it cannot be recovered.') }}
                                                    </p>
